...
public class AppController {
    ...
    private final VisualisationsService service;
    private final PipelineService pipelineService;

    public AppController(VisualisationsService service, PipelineService pipelineService) {
	...
	public String editorEdit(@PathVariable("id") String id, Model model) throws Exception {
        String config = pipelineService.get(id).get("widgets").toString();
	...
	public String pipeline(@PathVariable("id") String id, Model model) throws Exception {
        ...
        System.out.println(pipelineService.get(id));
