...
public class AppController {
    ...
    public String demo(Model model) throws JsonProcessingException {
        ...
        model.addAttribute("text",
                "[{\"text\":\"Zebras\",\"label\":\"NOUN | Animal\",\"color\":\"#efb118\"},{\"text\":\" are primarily \"},{\"text\":\"grazers\",\"label\":\"NOUN\",\"color\":\"#ff725c\"},{\"text\":\" and can subsist on lower-quality \"},{\"text\":\"vegetation\",\"label\":\"NOUN\",\"color\":\"#6cc5b0\"},{\"text\":\". They are preyed on mainly by \"},{\"text\":\"lions\",\"label\":\"NOUN | Animal\",\"color\":\"#3ca951\"},{\"text\":\", and typically flee when threatened but also bite and kick.\"}]");
        return "demo";
    }
}
